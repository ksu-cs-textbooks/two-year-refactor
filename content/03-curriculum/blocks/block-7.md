...
# Block 7 — INTEGRATION & JUDGMENT — design under uncertainty
...
|---|---|---|---|
| CS-206 | **Graphs & Network Algorithms** | 1 | Graph traversal, shortest path, minimum spanning trees — named explicitly as optimization (best path/structure under a metric). Graphs as the most general representation (terminal Data Structures pass). Signature assessment: Design Review begins here. |
...
|---|---|---|---|
| MATH-104 | **Discrete Math: Graphs, Trees, and Networks** | 1 | (External/co-designed course.) |
...
- **HCI / Accessible Design** — Defend usability and accessibility choices in Design Review (pass 3).
- **Security/Privacy/Ethics (lens)** — Re-identification risk from combined datasets — a specific, real privacy question (not a generic touch).
- **Testing & Formal Verification** — Both applied to harder cases (graphs).
