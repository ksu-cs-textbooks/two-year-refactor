...
A clean four-pass escalation in what the student does with a networked boundary.
...
- The network boundary is the B4 pass of Boundaries & Contracts. If OSI Networking Fundamentals is adopted, it becomes the theory this practical thread applies.

## Open questions for faculty review

1. OSI Networking Fundamentals placement and credits remain deferred to cross-block optimization.
