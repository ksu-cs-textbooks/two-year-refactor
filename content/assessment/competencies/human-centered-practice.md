...
| B6 | CS-205 | Team Software Project scoping — assessed requirements artifact: conduct a stakeholder interview and produce a functional/non-functional requirements brief before implementation begins |
| B7 | CS-206/207 | Design Review — defending choices against stated requirements; requirements surface through critique |
| B8 | CS-209 | Primary home — formal requirements gathering methods; stakeholder interviews; qualitative and quantitative investigation; translating ambiguous needs into acceptance criteria |
...
| B7 | CS-206/207 | Design Review — defending human-centered design choices under peer scrutiny; usability as a named dimension of the critique |
| B8 | CS-209 | Primary home — requirements-driven design; UX research methods; validation with real users; escalation from accessibility-checklist compliance to fitness-for-purpose |
...
| B7 | CS-206 | Design Review — peers evaluate each other's system designs for human-centeredness and usability fit | Peer-facing, multi-dimension |
...
| B6 | CS-204 | Threat identification, authentication, authorization; least data collection as a security and ethical principle |
| B6 | CS-205 | Responsibility retrospective — Team Software Project includes an assessed ethical accountability reflection |
| B7 | CS-207 | Re-identification risk — combining individually innocuous datasets creates privacy harms neither dataset posed alone |
| B8 | CS-208 | Harden-before-live as ethical practice; blameless postmortem as systemic rather than blame-based accountability |
| B8 | CS-210 | Data ethics, honest visualization, AI-generated code critique for correctness, security, and responsible use |
...
| B6 | CS-203 | Test naming and documentation — what does this test guarantee, and for whom? |
| B6 | CS-205 | PR descriptions, commit messages, code review comments — professional asynchronous technical communication |
| B7 | CS-206/207 | Design Review — present and defend technical decisions to a critical peer and faculty audience; highest-stakes synchronous technical communication in the program |
| B8 | CS-208 | Operational runbooks and API documentation — technical communication that outlives the author and must be read under pressure |
| B8 | CS-209 | Stakeholder communication — translate technical constraints and design decisions for non-technical decision-makers |
...
| Adaptation | Design Review (B7) — defend technical decisions under live critique; CS-209 stakeholder translation — communicate technical constraints to non-technical users with real decision-making consequences |
